...
ROS2_DDS_THREATS: list[ROSThreat] = [
    ROSThreat(
        ...
        mitigation="Use SROS2 with DDS security plugin. Enforce domain isolation and node identity certificates.",
        severity="CRITICAL",
    ),
    ROSThreat(
        threat_id="ROS-T-001",
        ...
        mitigation="Implement message authentication. Validate command source via node identity in SROS2.",
        severity="CRITICAL",
    ),
    ROSThreat(
        threat_id="ROS-I-001",
        ...
        mitigation="Enable DDS access control plugin. Restrict topic read permissions to authorized nodes only.",
        severity="HIGH",
    ),
    ROSThreat(
        threat_id="ROS-D-001",
        ...
        mitigation="Enable DDS participant authentication. Set discovery peer lists explicitly in DDS QoS config.",
        severity="HIGH",
    ),
]
