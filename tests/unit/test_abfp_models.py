...
class TestMessageEvent:
    def test_to_dict(self):
        ev = MessageEvent(topic="sensors/temp", payload_size=48, timestamp=1000.0, qos=1)
        d = ev.to_dict()
...
class TestAgentFingerprint:
    def setup_method(self):
        self.fp = AgentFingerprint(agent_id="inferred_sensors_sensor_001", first_seen=1000.0, last_seen=1120.0)
...
class TestBehavioralBaseline:
    def test_deviation_new_topics(self):
        ...
        fp = AgentFingerprint(agent_id="sensor", first_seen=0, last_seen=60)
